...
# taxa <- read.xlsx("Data/PFdata.xlsx", sheet = "MacroperforateSpp")
# taxa.micro <- read.xlsx("PFdata.xlsx", sheet = "MicroperforateSpp")
# 
...
pan.model.type <- read_xlsx("Data/age_models.xlsx", sheet = "pangaea")
