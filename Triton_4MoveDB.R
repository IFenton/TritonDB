...
# Lab book: Lab book Foram database.docx
#
# Adding the data from Graeme Lloyds (2011) palaeobiology paper
...
# save(list = eval(parse(text = "moveDB.tables")), file = "Data/moveDB.RData")
# load("Data/moveDB.RData")
...
# 3c. PNstructure ---------------------------------------------------------
movedb.model.type <- read_xlsx("Data/moveDB_age_models.xlsx")
